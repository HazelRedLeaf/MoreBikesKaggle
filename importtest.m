function example_leaderboard_submission = importleaderboard(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   example_leaderboard_submission = IMPORTFILE1(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   example_leaderboard_submission = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   example_leaderboard_submission = importfile1('station_201_deploy.csv', 2, 746);
%
%    See also TEXTSCAN.
...
example_leaderboard_submission = table;
example_leaderboard_submission.Id = cell2mat(raw(:,1));
example_leaderboard_submission.bikes = cell2mat(raw(:, 2));
